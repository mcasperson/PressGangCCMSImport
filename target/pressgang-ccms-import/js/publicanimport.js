                ...
                if (!config.InputSource) {
                    ...
                    qnastart.zipModel.getCachedEntries(config.InputSource, function (entries) {
                        ...
                        if (!foundPublicanCfg) {
                            ...
                            qnastart.zipModel.getTextFromFileName(config.InputSource, "publican.cfg", function(publicanCfg) {
                                    ...
                                    function processEntry(index, callback) {
                                        if (index >= entries.length) {
                                            ...
                                            if (/\.cfg$/.test(uri.filename())) {
                                                qnastart.zipModel.getTextFromFileName(config.InputSource, entry.filename, function(configFile) {
