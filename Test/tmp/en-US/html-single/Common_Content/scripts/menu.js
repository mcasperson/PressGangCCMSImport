...
function loadMenu2(ajq, toc_path, current_product, current_version, current_book) {
    ...
    if(typeof current_product != "undefined" && current_product != '') {
        ...
        if(typeof current_version != "undefined" && current_version != '') {
            html += '<span id="product_menu" onmouseover="work=1; expand_menu(\'product_menu_list\');" onmouseout="work=1; retract_menu(\'product_menu_list\');">' + prod_label + '</span>';
            if(typeof current_book != "undefined" && current_book != '') {
                html += '<span id="version_menu" onmouseover="work=1; expand_menu(\'version_menu_list\');" onmouseout="work=1; retract_menu(\'version_menu_list\');">' + current_version + '</span>';
