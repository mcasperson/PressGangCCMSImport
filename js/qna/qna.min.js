...
function(l,d){if(this.step&&this.step.nextStep){var c=function(b){return function(c){b.step.nextStep(c[c.length],b.config,function(b){return function(e){e&&l(new a.QNA(e,b.previousSteps.concat([b.step]),c,b.config,b.updatedCallback,d))}}(b),function(b,a){d(b,a)})}}(this);this.step.processStep?this.step.processStep(this.results[this.results.length],this.config,function(b){return function(a){c(b.concat([a]))}}(this.results),function(b,a){d(b,a)}):c(this.results.concat([this.results[this.results.length]]))}else d("An error occurred.",
