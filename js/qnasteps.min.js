(function(b){b.QNAStart=new b.QNAStep(function(a){a("Select the ZIP file to import")},function(a){a("Select the ZIP file that contains the valid Publican book that you wish to import into PressGang CCMS.")},function(a){a([new b.QNAVariables(null,function(a){a([new b.QNAVariable(function(c){c(b.InputEnum.SINGLE_FILE)},function(c){c("Publican ZIP File")},function(c){c("ZipFile")})])})])},function(a,e,c,d){(new b.QNAZipModel).getCachedEntries(d.ZipFile,function(c){var d=!1;b.angular.forEach(c,function(c,
...
function(d){if(d=/<title>(.*?)<\/title>/.exec(d)){var f="en-US/"+d[1].replace(/ /g,"_")+".xml";b.angular.forEach(e,function(b,e){b.filename===f&&a(f)})}}),!1})});a(null)})])})])},null,function(a){a(k)}),k=new b.QNAStep(function(a){a("Create or overwrite a content spec?")},function(a){a("This wizard can create a new content specification, or overwrite the contents of an existing one. You will usually want to create a new content specification, but if you are reimporting a book and want to overwrite the previously imported content spec, select the overwrite option.")},
...
function(a){a([new b.QNAVariables(null,function(a){a([new b.QNAVariable(function(a){a(b.InputEnum.TEXTBOX)},function(a){a("Existing content specification ID")},function(a){a("ExistingContentSpecID")},null,null)])})])},null,function(a){a(g)}),g=new b.QNAStep(function(a){a("Create or overwrite a content spec?")},function(a){a("This wizard can create a new content specification, or overwrite the contents of an existing one. You will usually want to create a new content specification, but if you are reimporting a book and want to overwrite the previously imported content spec, select the overwrite option.")},
function(a){a([new b.QNAVariables(null,function(a){a([new b.QNAVariable(function(a){a(b.InputEnum.RADIO_BUTTONS)},function(a){a(["Create a new content spec","Overwrite an existing content spec"])},function(a){a("CreateOrOverwrite")},function(a){a(["CREATE","OVERWRITE"])},function(a){a("CREATE")})])})])},null,function(a,b,c,d){a(the_next_step)})})(this);
