...
function(a){a("Parse as XML")},function(a){a("ParsedAsXML")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Finding revision history")},function(a){a("FoundRevisionHistory")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Finding author group")},function(a){a("FoundAuthorGroup")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Finding and uploading images")},function(a){a("FoundImages")},null,null),
new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Resolving book structure")},function(a){a("ResolvedBookStructure")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Resolving xrefs")},function(a){a("ResolvedXrefs")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Uploading content specification")},function(a){a("UploadedContentSpecification")},null,null),new b.QNAVariable(function(a){a(b.InputEnum.PROGRESS)},function(a){a("Progress")},
function(a){a("UploadProgress")},null,function(a){a([11,0])})])})])},function(c,e,a,d){var g=[],k=function(a){var b="",e;-1!==(e=d.MainXMLFile.lastIndexOf("/"))&&(b=d.MainXMLFile.substring(0,e));f.getCachedEntries(d.ZipFile,function(e){var p=function(l){if(l>=e.length)d.UploadProgress[1]=3,d.FoundEntityDefinitions=!0,c(),n(a);else{var h=e[l];0===h.filename.indexOf(b)?f.getTextFromFile(h,function(a){for(var b=/<!ENTITY\s+[^\s]+\s+('|").*?('|")\s*>/g,c;c=b.exec(a);)-1===g.indexOf(c[0])&&g.push(c[0]);
p(l+1)}):p(l+1)}};p(0)})},n=function(a){a=a.replace(/<\?xml.*?>/g,"");a=a.replace(/<!DOCTYPE[\s\S]*?\[[\s\S]*?\]>/g,"");d.UploadProgress[1]=4;d.RemovedXMLPreamble=!0;c();var e;b.DOMParser?(new b.DOMParser).parseFromString(a,"text/xml"):(e=new b.ActiveXObject("Microsoft.XMLDOM"),e.async=!1,e.loadXML(a));d.UploadProgress[1]=5;d.ParsedAsXML=!0;c()};(function(){var a=/<\s*xi:include\s+xmlns:xi\s*=\s*("|')http:\/\/www\.w3\.org\/2001\/XInclude("|')\s+href\s*=\s*("|')(.*?\.xml)("|')\s*\/\s*>/,g=/^Common_Content/,
m=function(b,c,l){var h=a.exec(b);if(h){var q="",r;-1!==(r=c.lastIndexOf("/"))&&(q=c.substring(0,r));if(g.test(h[4]))m(b.replace(h[0],""),c,l);else{var k=q+"/"+h[4];f.getTextFromFileName(d.ZipFile,k,function(a){m(a,k,function(a){m(b.replace(h[0],a),c,l)})},function(a){e(a)})}}else l(b)};f.getTextFromFileName(d.ZipFile,d.MainXMLFile,function(a){m(a,d.MainXMLFile,function(a){d.UploadProgress[1]=1;d.ResolvedXIIncludes=!0;c();for(var e=/&.*?;/,h=[],f;f=e.exec(a);){for(var g;-1!==a.indexOf(g="#"+Math.floor(1E9*
Math.random()+1)+"#"););h.push({placeholder:g,entity:f[0]});a=a.replace(RegExp(b.escapeRegExp(f[0]),"g"),g)}d.UploadProgress[1]=2;d.FoundEntities=!0;c();k(a)})})})()},null,function(b,e,a,d){b(the_next_step)})})(this);
