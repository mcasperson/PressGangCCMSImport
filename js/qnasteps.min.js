(function(b){b.QNAStart=new b.QNAStep(function(b){b("Select the ZIP file to import")},function(b){b("Select the ZIP file that contains the valid Publican book that you wish to import into PressGang CCMS.")},function(c){c([new b.QNAVariables(null,function(c){c([new b.QNAVariable(function(a){a(b.InputEnum.SINGLE_FILE)},function(a){a("Publican ZIP File")},function(a){a("ZipFile")})])})])},null,function(c,d,a,e){e.ZipFile?(new b.QNAZipModel).getCachedEntries(e.ZipFile,function(a){var e=!1;b.angular.forEach(a,
...
function(d){if(d=/<title>(.*?)<\/title>/.exec(d)){var e="en-US/"+d[1].replace(/ /g,"_")+".xml";b.angular.forEach(c,function(b,c){b.filename===e&&a(e)})}}),!1})});a(null)})])})])},null,null,function(b){b(k)}),k=new b.QNAStep(function(b){b("Create or overwrite a content spec?")},function(b){b("This wizard can create a new content specification, or overwrite the contents of an existing one. You will usually want to create a new content specification, but if you are reimporting a book and want to overwrite the previously imported content spec, select the overwrite option.")},
function(c){c([new b.QNAVariables(null,function(c){c([new b.QNAVariable(function(a){a(b.InputEnum.RADIO_BUTTONS)},function(a){a(["Create a new content spec","Overwrite an existing content spec"])},function(a){a("CreateOrOverwrite")},function(a){a(["CREATE","OVERWRITE"])},function(a){a("CREATE")})])})])},null,null,function(b,d,a,e){b("CREATE"===e.CreateOrOverwrite?g:l)}),l=new b.QNAStep(function(b){b("Create or overwrite a content spec?")},function(b){b("This wizard can create a new content specification, or overwrite the contents of an existing one. You will usually want to create a new content specification, but if you are reimporting a book and want to overwrite the previously imported content spec, select the overwrite option.")},
function(c){c([new b.QNAVariables(null,function(c){c([new b.QNAVariable(function(a){a(b.InputEnum.TEXTBOX)},function(a){a("Existing content specification ID")},function(a){a("ExistingContentSpecID")},null,null)])})])},null,null,function(b){b(g)}),g=new b.QNAStep(function(b){b("Importing Publican Book")},null,null,function(c){c([new b.QNAVariables(null,function(c){c([new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Resolving xi:includes")},function(a){a("ResolvedXIIncludes")},
...
null),new b.QNAVariable(function(a){a(b.InputEnum.CHECKBOX)},function(a){a("Uploading content specification")},function(a){a("Uploaded content specification")},null,null)])})])},null,function(b,d,a,e){b(the_next_step)})})(this);
